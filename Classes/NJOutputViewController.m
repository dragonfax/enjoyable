...
- (void)cleanUpInterface {
    ...
    if (row != 3) {
        ...
        self.mouseSpeedSlider.floatValue = (float)self.mouseSpeedSlider.minValue;
    ...
    if (row != 5) {
        ...
        self.scrollSpeedSlider.floatValue = (float)self.scrollSpeedSlider.minValue;
...
- (IBAction)scrollTypeChanged:(NSButton *)sender {
    ...
    if (sender.state == NSOnState) {
        self.scrollSpeedSlider.floatValue = (float)(
...
- (NJOutput *)makeOutput {
    switch (self.radioButtons.selectedRow) {
        ...
        case 4: {
            ...
            mb.button = (CGMouseButton)[self.mouseBtnSelect.cell tagForSegment:self.mouseBtnSelect.selectedSegment];
            return mb;
        }
        case 5: {
